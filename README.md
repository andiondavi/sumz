<div align="center">
  <br />
    <img src="https://i.imgur.com/MwJUmSx.png" alt="Project Banner">
  <br />
  <br />
...
Sumz - AI Article Summarizer Website, developed using React.js, Redux and Tailwind CSS, is a tool that can extract the body of any article or website from a URL and summarize its content using GPT using an API request. In it you can copy your summary or browse the history of your summaries and copy its URL.
...
```bash
git clone https://github.com/andiondavi/sumz.git
cd sumz
```
...
```env
VITE_RAPID_API_ARTICLE_KEY=yourkey
```
...
- [Assets](https://drive.google.com/file/d/11DLzrWADT-GyhuHpWXobhUwqV8peC0ef/view)
- [Live Website](https://sumz-davi-andions-projects.vercel.app/)
