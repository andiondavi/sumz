        ...
        <section className='mt-16 w-full max-w-xl'>
            ...
            <div className="my-10 max-w-full flex justify-center items-center">
                {isFetching ? (
                    ...
                    <p className='font-inter font-bold text-black text-center'>Well, that wasn't suppose to happen...<br /><span className='font-satoshi font-normal text-gray-700'>{error?.data?.error}</span></p>
                ) : article.summary && (
